...
- **Basic Mechanism**: 
    ...
    - **Due to the limited bandwidth of PCIe**
        ...
        - Each linear operation: $\boldsymbol{\hat{W}x}$ &rarr; $(\boldsymbol{\hat{W}}+\boldsymbol{R}\odot \boldsymbol{M})\boldsymbol{x}$
...
- **When certain activation values are noticeably large**   
    &rarr; Even small quantization errors in the **corresponding weight channels** can be **multiplied** and **amplified** as shown in `Figure 3`.   
