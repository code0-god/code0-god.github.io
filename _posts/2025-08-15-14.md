...
- **When certain activation values are noticeably large**   
    &rarr; Even small quantization erros in the corresponding weight channels can be **multiplied** and **amplified** as shown as `Figure 3`.   
    &rarr; Considerable **perturbations** in the output.
